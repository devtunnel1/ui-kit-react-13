...
function SelectedDisabled (props) {
  return (
    <SvgIcon {...props}>
      ...
      <polygon points="7.75475714 12.1012424 6.5 13.5087798 10.9495988 18.5 19.5 8.91752268 18.2452429 7.5 10.9495988 15.67499" fill="#A2A6AB"></polygon>
    </SvgIcon>
  )
}

export { SelectedDisabled }
